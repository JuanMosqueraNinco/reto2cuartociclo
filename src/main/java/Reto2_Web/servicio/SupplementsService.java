...
public class SupplementsService {
   ...
   public Optional<Inventario> getClothe(String reference) {
    ...
    public Inventario create(Inventario accesory) {
    ...
    public Inventario update(Inventario accesory) {

        if (accesory.getReference() != null) {
            Optional<Inventario> accesoryDb = clotheRepository.getClothe(accesory.getReference());
